...
async function create(octokit, data) {
  ...
  /* TODO(tabatkins, 2020-06-08)
    more ways to link to a WPT:
    * http://wpt.live/css/cssom/historical.html
    * https://github.com/web-platform-tests/wpt/blob/master/css/cssom/historical.html
        (also branch name will eventually change from master to main)
    * Links to PRs like web-platform-tests/wpt#11163
  */
